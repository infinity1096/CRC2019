...
public class DifferentialDrive {
    ...
    public void solveForwardDynamics(DriveDynamics dynamics) {
        final boolean left_stationary = Util.epsilonEqual(dynamics.wheel_velocity.left, 0.0)
                && Math.abs(dynamics
                .voltage.left) < left_transmission_.friction_voltage();
        final boolean right_stationary = Util.epsilonEqual(dynamics.wheel_velocity.right, 0.0) && Math.abs(dynamics
    ...
    public double getMaxAbsVelocity(double curvature, /*double dcurvature, */double max_abs_voltage) {
        ...
        if (Util.epsilonEqual(curvature, 0.0)) {
    ...
    public static class DriveDynamics   {
        ...
        public String toString(){
            String s ;
            s = "Dynamics:\n";
            s += "\tVelocity: " + wheel_velocity.toString() + "\n";
            s += "\tAcceleration: " + wheel_acceleration.toString() + "\n";
            s += "\tTorque: " + wheel_torque.toString() + "\n";
            s += "\tVoltage: " + voltage.toString() + "\n";
            s += "\tChassis Velocity: " + chassis_velocity.toString() + "\n";
            s += "\tChassis Acceleration: " + chassis_acceleration.toString() + "\n";
